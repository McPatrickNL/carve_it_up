...
public class ModBlocks
{
    ...
    public static final Map<String, RegistryObject<BlockItem>> BLOCKS_ITEMS_MAP = new LinkedHashMap<>();
    
    public static final RegistryObject<Block> EXAMPLE_BLOCK =
            BLOCKS.register("example_block", properties -> new Block(properties.destroyTime(1.5f)));
    
    public static final RegistryObject<BlockItem> EXAMPLE_BLOCK_ITEM =
            BLOCKS.registerBlockItem("example_block", properties -> new BlockItem(EXAMPLE_BLOCK.get(), properties));
